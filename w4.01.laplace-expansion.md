...
Expanding in powers of $r$, near $r=0$:

$$
\Phi(r,z) = a_0(z) + r\, a_1(z) + r^2\, a_2(z) + r^3\, a_3(z) + r^4\, a_ 4(z) + \cdots
$$

and dropping odd terms due to cylindrical symmetry making the field is invariant under $r\rightarrow -r$

$$
\Phi(r,z) = a_0(z) + r^2\, a_2(z) + r^4\, a_ 4(z) + \cdots
$$

Plugging this into Laplace's equation, we can relate radial derivatives to purely axial derivatives.
