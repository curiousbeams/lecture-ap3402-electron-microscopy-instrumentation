...
For a more interactive experience, open {download}`./notebooks/w4.03.ray-diagrams.nb` in [Mathematica](https://www.tudelft.nl/studenten/mijn-studie-ik/studietools/software).
:::
...
We can also make an interactive version of the ray diagram, by wrapping these functions in a `DynamicModule`.
...
::::{figure}
:label: fig_interactive_ray_diagram
...
Interactive SEM ray diagram.
JS code available at: https://observablehq.com/@gvarnavi/ray-diagrams
